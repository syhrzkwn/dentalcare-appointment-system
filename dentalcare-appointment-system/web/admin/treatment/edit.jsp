<%-- 
    Document   : edit
    Created on : Dec 20, 2022, 1:02:08 AM
    Author     : syahir
--%>
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    ...
                                    <div class="card-body p-5">
                                        <form method="post" action="${pageContext.servletContext.contextPath}/treatment_update.do">
                                            <c:forEach var="result" items="${results.rows}">
                                                <div class="form-group col-md-6 mb-3">
                                                    <label for="title">Title <span class="text-danger">*</span></label>
                                                    <input type="text" class="form-control" id="title" value="${result.treat_title}" name="title">
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label for="desc">Description <span class="text-danger">*</span></label>
                                                    <textarea class="form-control" id="desc" rows="3" name="desc">${result.treat_desc}</textarea>
                                                </div>
